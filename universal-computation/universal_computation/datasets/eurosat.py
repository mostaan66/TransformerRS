...
class EuroSATRGBDataset(Dataset):
    ...
    def __init__(self, batch_size, patch_size=None, data_aug=False, *args, **kwargs):
...
#            transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),
        ...
        self.d_train = DataLoader(
            torchvision.datasets.ImageFolder('/content/drive/MyDrive/GitHub/RSdataset/data/eurosat-rgb/split/train/', transform=transform),
            batch_size=batch_size, drop_last=True, shuffle=True,
        )
        self.d_test = DataLoader(
            torchvision.datasets.ImageFolder('/content/drive/MyDrive/GitHub/RSdataset/data/eurosat-rgb/split/test/', transform=val_transform),
            batch_size=batch_size, drop_last=True, shuffle=True,
        )
